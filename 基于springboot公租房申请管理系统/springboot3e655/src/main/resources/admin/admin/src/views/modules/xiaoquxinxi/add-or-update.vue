	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="小区人数" prop="xiaoqurenshu">
					<el-input v-model="ruleForm.xiaoqurenshu" placeholder="小区人数" clearable  :readonly="ro.xiaoqurenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="小区人数" prop="xiaoqurenshu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="小区简介" prop="xiaoqujianjie">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.xiaoqujianjie" label="小区简介" prop="xiaoqujianjie">
