<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="缴费单号" prop="jiaofeidanhao">
					<el-input v-model="ruleForm.jiaofeidanhao" placeholder="缴费单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiaofeidanhao" label="缴费单号" prop="jiaofeidanhao">
					<el-input v-model="ruleForm.jiaofeidanhao" placeholder="缴费单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="缴费月份" prop="jiaofeiyuefen">
					<el-select :disabled="ro.jiaofeiyuefen" v-model="ruleForm.jiaofeiyuefen" placeholder="请选择缴费月份" >
						<el-option
							v-for="(item,index) in jiaofeiyuefenOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费月份" prop="jiaofeiyuefen">
					<el-input v-model="ruleForm.jiaofeiyuefen"
						placeholder="缴费月份" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="缴费名称" prop="jiaofeimingcheng">
					<el-input v-model="ruleForm.jiaofeimingcheng" placeholder="缴费名称" clearable  :readonly="ro.jiaofeimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费名称" prop="jiaofeimingcheng">
					<el-input v-model="ruleForm.jiaofeimingcheng" placeholder="缴费名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="缴费类型" prop="jiaofeileixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费类型" prop="jiaofeileixing">
					<el-input v-model="ruleForm.jiaofeileixing"
						placeholder="缴费类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="缴费金额" prop="jiaofeijine">
					<el-input v-model="ruleForm.jiaofeijine" placeholder="缴费金额" clearable  :readonly="ro.jiaofeijine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费金额" prop="jiaofeijine">
					<el-input v-model="ruleForm.jiaofeijine" placeholder="缴费金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="添加日期" prop="tianjiariqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.tianjiariqi" label="添加日期" prop="tianjiariqi">
					<el-input v-model="ruleForm.tianjiariqi" placeholder="添加日期" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="缴费内容" prop="jiaofeineirong">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiaofeineirong" label="缴费内容" prop="jiaofeineirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jiaofeineirong}}</span>
				</el-form-item>
