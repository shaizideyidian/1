					...
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							<div class="layui-input-block"  style="display: flex;flex-wrap:wrap;">
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto 0","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"rgba(15, 141, 80, 1)","color":"#fff","borderRadius":"8px","borderWidth":"1px","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">修改</button>
