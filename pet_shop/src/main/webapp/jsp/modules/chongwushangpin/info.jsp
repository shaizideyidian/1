		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="shangpinpinpai" name="shangpinpinpai" class="form-control" v-model="ruleForm.shangpinpinpai" readonly>
				</div>
				<div class="form-item">
					<label>商品折扣</label>

					<input id="shangpinzhekou" name="shangpinzhekou" class="form-control" v-model="ruleForm.shangpinzhekou" readonly>
				</div>
				...
				<div class="form-item">
					...
					<input id="vipprice" name="vipprice" class="form-control" v-model="ruleForm.vipprice" readonly>
				</div>
