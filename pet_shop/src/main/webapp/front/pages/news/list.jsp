...
<html>
	...
	<body>
		...
		<div id="app">
			<!-- 轮播图 -->
			<div class="layui-carousel" id="test1" :style='{"boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"20px auto","borderColor":"rgba(0,0,0,.3)","borderRadius":"20px","borderWidth":"0","width":"80%","borderStyle":"solid"}'>
			  <div carousel-item>
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px auto","borderColor":"rgba(15, 141, 80, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0 5px","fontSize":"16px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>站内公告</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(0,0,0,0.5)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(240, 240, 240, 1)","borderRadius":"0","borderWidth":"0","background":"rgb(242, 242, 242)","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#fff","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"20px","borderStyle":"solid"}'>标题</div>
					...
					<div class="list news">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="2=='1'?'list-item1':2=='3'?'list-item3':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"none","borderColor":"rgba(0,0,0,.3)","borderRadius":"0 40px","borderWidth":"0","width":"50%","borderStyle":"solid","height":"200px"}' :src="baseurl+item.picture">
								<div class="item-info">
									...
									<div v-if="item.introduction" :style='{"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"16px"}' class="time">{{item.introduction}}</div>
								</div>
							</div>
						</div>
					</div>
