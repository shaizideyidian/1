...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">联系记录管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>联系记录管理</span></li>
				<li class="breadcrumb-item-two"><span>联系记录列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>咨询时间</label>
					<div class="item-body">
						<input id="zixunshijian_start" class="begin Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
						<span>至</span>
						<input id="zixunshijian_end" class="end Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
					</div>
				</div>
				<div class="form-item">
					<label>审核状态</label>
	...
	<script>
		...
		function search(){
			...
			if($('#zixunshijian_start').val() != null && $('#zixunshijian_start').val() != ''){
				searchForm.zixunshijian_start = $('#zixunshijian_start').val();
			}
			if($('#zixunshijian_end').val() != null && $('#zixunshijian_end').val() != ''){
				searchForm.zixunshijian_end = $('#zixunshijian_end').val();
			}
        ...
        function getDataList() {
			http("lianxijilu/page","GET",{
				...
				zixunshijian_start : searchForm.zixunshijian_start,
				zixunshijian_end : searchForm.zixunshijian_end,
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("lianxijilu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("lianxijilu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("lianxijilu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"lianxijilu");
