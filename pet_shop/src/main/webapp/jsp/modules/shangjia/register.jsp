...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="shangjiamingcheng"  placeholder="请输入商家名称" class="form-control-i">
				</div>
				<div class="list-item">
                ...
                <div class="list-item-img">
                    ...
                    <div class="upload btn-img">请选择商家图片<input name="file" type="file" id="shangjiatupianupload" class="form-control-file"></div>
                    <input name="shangjiatupian" id="shangjiatupian-input" type="hidden">
                </div>
				<div class="list-item">
					<input  name="shangjialeixing"  placeholder="请输入商家类型" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="zixundianhua"  placeholder="请输入咨询电话" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="shangjiadizhi"  placeholder="请输入商家地址" class="form-control-i">
				</div>
