								...
								<tbody>
									<tr v-for="(item,index) in dataList" v-bind:key="index">
										...
										<td style="width: 100px;">
                                            ...
                                            <button v-if="item.status=='未支付'" @click="alipay(item)" type="button" class="layui-btn layui-btn-sm layui-btn-radius btn-theme">
                                                    沙箱支付
                                            </button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
                    ...
                    // 沙箱支付
                    alipay(item) {
                        layui.http.request(`orders/alipay`, 'get',{"tradeno":item.orderid,"totalamount":item.total,"subject":item.goodname}, (res) => {
                            if(res.code == 0){
