	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>商家名称</label>
					<input name="shangjiamingcheng" readonly id="shangjiamingcheng" name="shangjiamingcheng" class="form-control" placeholder="请输入商家名称">
				</div>
				<div class="form-item-img">
					<label>商家图片</label>
					<img id="shangjiatupianImg" src="" width="100" height="100">
		...
		function upload(){
			$('#shangjiatupianupload').fileupload({
				...
				dataType: 'json',
					...
					$("#shangjiatupianImg").attr("src",baseUrl+"upload/"+data.result.file);								
				}
			});
		}  
		//取消 
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					$("#shangjiatupianImg").attr("src",baseUrl+res.data.shangjiatupian);
					$("#shangjiatupian-input").val(res.data.shangjiatupian);
					}
