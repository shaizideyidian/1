...
public class ChongwushangpinController {
    ...
    public R page(@RequestParam Map<String, Object> params,ChongwushangpinEntity chongwushangpin, 
		...
		if(tableName.equals("shangjia")) {
			chongwushangpin.setShangjiamingcheng((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ChongwushangpinEntity> wrapper = new EntityWrapper<ChongwushangpinEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = chongwushangpinService.selectCount(wrapper);
