...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">宠物商品管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>宠物商品列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>商品品牌</label>
					<input type="text" id="shangpinpinpaiSearch" class="form-control form-control-sm" placeholder="请输入商品品牌" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>商品折扣</label>
					<select name="shangpinzhekou" id="shangpinzhekouSelect" class="form-control form-control-sm" aria-controls="tableId">
						<option value=" "></option>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('shangpinpinpai')">商品品牌<i id="shangpinpinpaiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('shangpinzhekou')">商品折扣<i id="shangpinzhekouIcon" class="fa fa-sort"></i></th>
						...
						<th onclick="sort('vipprice')">会员价<i id="vippriceIcon" class="fa fa-sort"></i></th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody></tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#shangpinpinpaiSearch').val() != null && $('#shangpinpinpaiSearch').val() != ''){
				searchForm.shangpinpinpai ="%" +  $('#shangpinpinpaiSearch').val() + "%";
			}
			
			var shangpinzhekouIndex = document.getElementById("shangpinzhekouSelect").selectedIndex;
			var shangpinzhekouOptions = document.getElementById("shangpinzhekouSelect").options;
			var shangpinzhekouSelectedOption = shangpinzhekouOptions[shangpinzhekouIndex]
			if(shangpinzhekouSelectedOption.text != null && shangpinzhekouSelectedOption.text != ''){
				searchForm.shangpinzhekou = shangpinzhekouSelectedOption.text;
			}
        ...
        function getDataList() {
			http("chongwushangpin/page","GET",{
				...
				shangpinpinpai : searchForm.shangpinpinpai,	
				shangpinzhekou : searchForm.shangpinzhekou,	
		...
		function setDataRow(item,number){
			...
			var shangpinpinpaiCell  = document.createElement('td');

						 shangpinpinpaiCell.innerHTML = item.shangpinpinpai;

			row.appendChild(shangpinpinpaiCell);
			var shangpinzhekouCell  = document.createElement('td');

						 shangpinzhekouCell.innerHTML = item.shangpinzhekou;

			row.appendChild(shangpinzhekouCell);
			...
			var vippriceCell  = document.createElement('td');

						  vippriceCell.innerHTML = item.vipprice; 
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chongwushangpin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusschongwushangpin/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"chongwushangpin");
