			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(0,0,0,0.3)","margin":"0","borderColor":"rgba(0, 0, 0, 0.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(15, 141, 80, 1)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"4px","borderWidth":"1px","borderStyle":"solid"}' class="layui-form-item layui-form-text">
							<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"18px","color":"#333","textAlign":"right"}' class="layui-form-label">联系人：</label>
						...
						<div :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(15, 141, 80, 1)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"4px","borderWidth":"1px","borderStyle":"solid"}' class="layui-form-item layui-form-text l-redio">
							<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"18px","color":"#333","textAlign":"right"}' class="layui-form-label">默认地址：</label>
						...
						<div class="layui-form-item">
							<div class="layui-input-block"  style="display: flex;flex-wrap:wrap;">
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto 0","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"rgba(15, 141, 80, 1)","color":"#fff","borderRadius":"8px","borderWidth":"1px","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">添加</button>
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"8px","borderWidth":"1px","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
							</div>
						</div>
					</form>
				</div>
