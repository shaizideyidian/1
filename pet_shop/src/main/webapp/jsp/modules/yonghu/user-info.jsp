...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>用户名</label>
					<input name="yonghuming" readonly id="yonghuming" name="yonghuming" class="form-control" placeholder="请输入用户名">
				</div>
				<div class="form-item">
					<label>姓名</label>
	...
	<script>
		...
		function dataBind(){
			...
			var vipOptions = document.getElementsByClassName("vipOption");
			for(var vipCount = 0; vipCount < vipOptions.length;vipCount++){
				if(vipOptions[vipCount].getAttribute('value') == ruleForm.vip){
					vipOptions[vipCount].setAttribute('selected','selected');
				}
			}
		}		
		//图片显示
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.vip != null && res.data.vip != ''){

					var vipOptions = document.getElementsByClassName("vipOption");
						for(var vipCount = 0; vipCount < vipOptions.length;vipCount++){
							if(vipOptions[vipCount].getAttribute('value') == res.data.vip){
								vipOptions[vipCount].setAttribute('selected','selected');
							}
						}
					}
