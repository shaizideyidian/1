...
public class LingyangjiluEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public LingyangjiluEntity() {
		
	}
	
	public LingyangjiluEntity(T t) {
		try {
	 ...
	 * 设置：领养单号
	 */
	public void setLingyangdanhao(String lingyangdanhao) {
		this.lingyangdanhao = lingyangdanhao;
	}
	/**
	 * 获取：领养单号
	 */
	public String getLingyangdanhao() {
		return lingyangdanhao;
	}
	/**
	 * 设置：宠物名称
	 */
