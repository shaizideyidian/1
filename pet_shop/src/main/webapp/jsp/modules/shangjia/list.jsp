...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">商家管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>商家列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>商家类型</label>
					<input type="text" id="shangjialeixingSearch" class="form-control form-control-sm" placeholder="请输入商家类型" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>商家地址</label>
					<input type="text" id="shangjiadizhiSearch" class="form-control form-control-sm" placeholder="请输入商家地址" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>审核状态</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>商家图片</th>
						<th onclick="sort('shangjialeixing')">商家类型<i id="shangjialeixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#shangjialeixingSearch').val() != null && $('#shangjialeixingSearch').val() != ''){
				searchForm.shangjialeixing ="%" +  $('#shangjialeixingSearch').val() + "%";
			}
			
			if($('#shangjiadizhiSearch').val() != null && $('#shangjiadizhiSearch').val() != ''){
				searchForm.shangjiadizhi ="%" +  $('#shangjiadizhiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shangjia/page","GET",{
				...
				shangjialeixing : searchForm.shangjialeixing,	
				shangjiadizhi : searchForm.shangjiadizhi,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var shangjiatupianCell  = document.createElement('td');

			            var shangjiatupianImg = document.createElement('img');
            shangjiatupianImg.setAttribute('src',item.shangjiatupian?(baseUrl+item.shangjiatupian.split(",")[0]):'');
			shangjiatupianImg.setAttribute('height',100);
			shangjiatupianImg.setAttribute('width',100);
			shangjiatupianCell.appendChild(shangjiatupianImg);


			row.appendChild(shangjiatupianCell);
			var shangjialeixingCell  = document.createElement('td');

						 shangjialeixingCell.innerHTML = item.shangjialeixing;

			row.appendChild(shangjialeixingCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "联系客服"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'lianxijilu','是','','')");
			if(crossBtnControl('联系客服') == true){
