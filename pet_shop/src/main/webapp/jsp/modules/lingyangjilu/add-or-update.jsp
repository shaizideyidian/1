...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑领养记录</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑领养记录</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>领养单号</label>
					<input id="lingyangdanhao" name="lingyangdanhao" class="form-control" value="" readonly>
				</div>
				<div class="form-item">
					<label>宠物名称</label>
				...
				<div class="form-item">
					<label>宠物性别</label>
					<input name="chongwuxingbie" id="chongwuxingbie" name="chongwuxingbie" class="form-control" placeholder="请输入宠物性别">
				</div>
				<div class="form-item">
					<label>宠物年龄</label>
				...
				<div class="form-item">
					<label>申请内容</label>
					<input name="shenqingneirong" id="shenqingneirong" name="shenqingneirong" class="form-control" placeholder="请输入申请内容">
				</div>
				<div class="form-item">
					<label>用户名</label>
	...
	<script>
		...
		function lingyangdanhaoUuid(){
			if($("#lingyangdanhao").val() == null || $("#lingyangdanhao").val() == "null" || $("#lingyangdanhao").val() == ""){
				$("#lingyangdanhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "lingyangjilu/info/" + id,
		...
		function submit() {
               //获取表单数据前取消禁用
                $("#shenqingriqi-input").attr('disabled',false);
				...
				if(crossrefid && crossuserid) {
					...
					http("lingyangjilu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("lingyangjilu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#lingyangdanhao").val(ruleForm.lingyangdanhao);	
			...
			$("#chongwuxingbie").val(ruleForm.chongwuxingbie);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.lingyangdanhao != null && res.data.lingyangdanhao != ''){

						$("#lingyangdanhao").val(res.data.lingyangdanhao);
						$("#lingyangdanhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.chongwuxingbie != null && res.data.chongwuxingbie != ''){
						...
						$("#chongwuxingbie").val(res.data.chongwuxingbie);
						$("#chongwuxingbie").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.shenqingneirong != null && res.data.shenqingneirong != ''){
						...
						$("#shenqingneirong").attr('readonly','readonly');
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#lingyangdanhao").attr('readonly','readonly');
                $("#chongwumingcheng").attr('readonly','readonly');
                $("#chongwutupian").attr('readonly','readonly');
                $("#chongwupinzhong").attr('readonly','readonly');
                $("#chongwuxingbie").attr('readonly','readonly');
                $("#chongwunianling").attr('readonly','readonly');
                $("#shenqingriqi-input").attr('disabled',true);
                $("#shangjiamingcheng").attr('readonly','readonly');
                $("#yonghuming").attr('readonly','readonly');
                $("#xingming").attr('readonly','readonly');
                $("#shouji").attr('readonly','readonly');
