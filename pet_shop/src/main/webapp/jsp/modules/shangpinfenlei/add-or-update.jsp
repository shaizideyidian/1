...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑商品分类</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑商品分类</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>商品分类</label>
					<input name="shangpinfenlei" id="shangpinfenlei" name="shangpinfenlei" class="form-control" placeholder="请输入商品分类">
				</div>
