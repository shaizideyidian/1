...
//        调用addressService.getList方法获取AreaId为areaId的地址信息，将结果存储在addressList中
...
//        调用addressService.getList方法获取可能的子地址信息，将结果存储在childAddressList中，这里使用了addressList中的第一个元素的address_areaId作为查询条件
