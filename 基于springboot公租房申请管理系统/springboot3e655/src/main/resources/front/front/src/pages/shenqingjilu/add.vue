...
<div :style='{"border":"1px solid #eee","padding":"20px","boxShadow":"0px 0px 0px #ccc,inset 0px 0px 0px 0px #eee","margin":"20px auto 0","borderRadius":"4px","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请编号" prop="shenqingbianhao">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="房屋楼号" prop="fangwulouhao">
            <el-input v-model="ruleForm.fangwulouhao" 
                placeholder="房屋楼号" clearable readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="房屋房号" prop="fangwufanghao">
            <el-input v-model="ruleForm.fangwufanghao" 
                placeholder="房屋房号" clearable readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="建筑面积" prop="jianzhumianji">
            <el-input v-model="ruleForm.jianzhumianji" 
                placeholder="建筑面积" clearable readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="房屋租金" prop="fangwuzujin">
            <el-input v-model="ruleForm.fangwuzujin" 
                placeholder="房屋租金" clearable readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请文件" prop="shenqingwenjian">
            <file-upload
            tip="点击上传申请文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}'  label="分配状态" prop="fenpeizhuangtai">
            <el-select v-model="ruleForm.fenpeizhuangtai" placeholder="请选择分配状态" disabled >
              <el-option
                  v-for="(item,index) in fenpeizhuangtaiOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请日期" prop="shenqingriqi" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="申请内容" prop="shenqingneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="申请内容"
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='fenpeizhuangtai'){
              this.ruleForm.fenpeizhuangtai = obj[o];
              this.ro.fenpeizhuangtai = true;
              continue;
            }
            if(o=='shenqingriqi'){
        ...
        this.fenpeizhuangtaiOptions = "已分配,未分配".split(',')
      },

    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('shenqingjilu/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('shenqingjilu/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('shenqingjilu/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
