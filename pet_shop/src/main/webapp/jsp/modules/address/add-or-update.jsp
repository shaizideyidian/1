	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>收货人</label>
					<input name="name" id="name" name="name" class="form-control" placeholder="请输入收货人">
				</div>
				<div class="form-item">
					<label>电话</label>
					<input name="phone" id="phone" name="phone" class="form-control" placeholder="请输入电话">
				</div>
				<div class="form-item">
					<label>是否默认地址[是/否]</label>
					<input name="isdefault" id="isdefault" name="isdefault" class="form-control" placeholder="请输入是否默认地址[是/否]">
				</div>
